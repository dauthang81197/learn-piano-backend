...
export class CreateLessonContentDto {
  ...
  @ApiPropertyOptional({
    example: '<p>Lý thuyết về nốt Đô...</p>',
    description: 'Nội dung text (chỉ dùng cho type=text)',
  })
  @IsString()
  @IsOptional()
  textData?: string;
  ...
  @ApiPropertyOptional({
    example: 120,
    description: 'Thời lượng video tính bằng giây (chỉ dùng cho type=video)',
  })
  @IsInt()
  @Min(0)
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'Sheet nhạc bài Cho Tôi',
    description: 'Chú thích ảnh (chỉ dùng cho type=image)',
  })
  @IsString()
  @IsOptional()
  caption?: string;
  ...
  @ApiPropertyOptional({
    example: 'Hình ảnh sheet nhạc',
    description: 'Alt text cho ảnh (chỉ dùng cho type=image)',
  })
  @IsString()
  @IsOptional()
  altText?: string;
